...
namespace GamePush
{
    public class GP_Triggers : GP_Module
    {
        ...
        public static TriggerData[] List()
        {
            ...
            return Utilities.UtilityJSON.GetArray<TriggerData>(triggers);
#else
        ...
        public static TriggerActive[] ActivatedList()
        {
            ...
            return Utilities.UtilityJSON.GetArray<TriggerActive>(triggers);
#else
        ...
        public static TriggerAllData GetTrigger(string idOrTag)
        {
            ...
            return Utilities.UtilityJSON.Get<TriggerAllData>(data);
#else
